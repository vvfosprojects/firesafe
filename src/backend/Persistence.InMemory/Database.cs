...
namespace Persistence.InMemory
{
    internal class Database
    {
        ...
        public Database()
        {
            ...
            {
                new Prodotto() { Prog  =  "38628", CodiceOmol = "PS1045D20D1IM00018", Tipo = new Tipo { Nome =  "O"}, Ditta = "MORFEUS S.p.A.", Classe = new Classe {Nome = " 1 IM"}, Firma = new DateTime(2010, 8, 18) ,  Scadenza  = new DateTime(2021, 06, 27),  Impiego  =  "MATERASSO",  MacroGruppo  =  "LETTI E DIVANI",  DenominazioneCommerciale  =  "SERIE LARA FR"},
